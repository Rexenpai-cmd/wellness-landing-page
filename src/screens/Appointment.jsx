    ...
    return (
        <section className="md:px-4.75 lg:px-7.5">
            <div className="flex items-center justify-center w-full m-h-[525px] flex-col lg:flex-row">
                <div className="relative flex items-start justify-center flex-col h-full px-22.5 py-12.5">
                    <div
                        style={{ backgroundImage: `url(${heroBg})` }}
                        className="w-full absolute top-0 left-0 right-0 bottom-0 bg-cover bg-center bg-no-repeat"
                    />
                    <div className="flex items-start justify-center flex-col z-10 gap-16.5">
                ...
                <div className=" h-131.25 w-141.75 shrink-0 bg-primary pt-12.5">

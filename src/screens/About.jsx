...
const About = () => {
    ...
    return (
        <div className="md:px-[19px] lg:px-[30px]" id="about">
            <div className="flex items-start justify-center gap-[60px] flex-col-reverse py-[52px] px-[20px] rounded-2xl bg-primary/7 md:px-[45px] md:py-[72px] lg:flex-row lg:px-[90px] lg:gap-[100px]">
                ...
                <div className="flex flex-col gap-[30px]">
                    ...
                    <div className="flex items-center justify-start">
                        <Button
                            className="bg-secondary px-[30px] py-[15px] w-fit"
                            primaryBtn
                        >
